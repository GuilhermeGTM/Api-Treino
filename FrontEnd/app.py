...
# ------------------- Progresso do Aluno -------------------
    ...
    def consultar_progresso_click(e):
        ...
        if response.status_code == 200:
            ...
            progress_result.value = (
                ...
                f"Aulas necessárias para proxima faixa: {progress.get('aulas_necessarias_para_proxima_faixa')}\n"
            )
        else:
    ...
    progress_button = ft.ElevatedButton(text="Consulta progresso", on_click=consultar_progresso_click)
...
# ------------------- Atualizar Aluno -------------------
    ...
    update_button = ft.ElevatedButton(text="Atualizar aluno", on_click=atualiar_aluno_click)
